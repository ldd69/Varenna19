...
\begin{equation}
    ...
    % TODO: Consider changing this to \chi^2(g(x,\theta); D_n)
    % (clearly the chi2 of the function depending on theta compared to D_n)
    % possibly this is unneccessary though: should define mathcal D as level 1
